package de.fruxz.sparkle.framework.util.visual.message
...
import de.fruxz.sparkle.framework.util.visual.message.DisplayType.*
...
import de.fruxz.sparkle.framework.util.visual.message.Transmission.Level.GENERAL
