package de.fruxz.sparkle.framework.util.extension

import de.fruxz.sparkle.framework.util.extension.data.ticks
import de.fruxz.sparkle.framework.util.extension.KeyFramesAlignment.*
 ...
 * @since 1.0
 */
fun Entity.showAnimatedTitle(title: List<Component>, subtitle: List<Component>, times: Times = Times(20.ticks, 60.ticks, 20.ticks), timeBetweenTicks: Duration = .1.seconds, alignment: KeyFramesAlignment = CENTER, renderFadeIn: Boolean = true) = SparkleApp.coroutineScope.launch {
