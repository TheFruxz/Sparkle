...
import de.fruxz.sparkle.framework.util.extension.add
import de.fruxz.sparkle.framework.util.extension.toSimpleLocation
...
import de.fruxz.sparkle.framework.util.positioning.relative.Shape.Direction.Y
...
interface Shape {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun independentCylinder(height: Double, radius: Double, direction: Direction = Y) =
	        CylindricalShape.of(height, radius, direction)
