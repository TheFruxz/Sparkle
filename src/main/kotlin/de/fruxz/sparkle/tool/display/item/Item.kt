...
import de.fruxz.sparkle.extension.paper.subNamespacedKey
...
import de.fruxz.sparkle.tool.display.item.PostProperty.*
import de.fruxz.sparkle.tool.display.item.action.ItemAction
import de.fruxz.sparkle.tool.display.item.action.ItemActionTag
import de.fruxz.sparkle.tool.display.item.action.ItemClickAction
import de.fruxz.sparkle.tool.display.item.action.ItemDropAction
import de.fruxz.sparkle.tool.display.item.action.ItemInteractAction
import de.fruxz.sparkle.tool.display.item.quirk.Quirk
