 ...
 */
@SparkleDSL
inline fun <reified T : JavaPlugin> instanceOrNull() = pluginManager.plugins.firstOrNull { it is T } as T?
...
@SparkleDSL
inline fun <reified T : JavaPlugin> instance() = instanceOrNull<T>() ?: throw NoSuchElementException("Plugin ${T::class.simpleName} not found!")
