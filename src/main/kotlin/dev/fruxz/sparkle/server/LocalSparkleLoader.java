...
public class LocalSparkleLoader implements PluginLoader {
    ...
    public void classloader(@NotNull PluginClasspathBuilder classpathBuilder) {
        ...
        maven.addRepository(new RemoteRepository.Builder("fruxz.dev", "default", "https://repo.fruxz.dev/releases").build());
        maven.addRepository(new RemoteRepository.Builder("fruxz.devDev", "default", "https://repo.fruxz.dev/dev").build());
