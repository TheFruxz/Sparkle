...
object MoltenLanguage {
    ...
    data class MoltenLanguageData(
        ...
        val languageData: List<MoltenLanguageElement> = languageDataOf(
            ...
            "system.prefix.general" to "<dark_gray>⏵ ",
            "system.prefix.info" to "<#FFF500>✉ <dark_gray>⏵ ",
            "system.prefix.fail" to "<#FF5A00>✘ <dark_gray>⏵ ",
            "system.prefix.error" to "<#FF0000>☄ <dark_gray>⏵ ",
            "system.prefix.level" to "<#FF00FE>" + "\uD83D\uDDE1 <dark_gray>⏵ ",
            "system.prefix.warning" to "<#F3FF00>⚐ <dark_gray>⏵ ",
            "system.prefix.attention" to "<#FFC900>⏳ <dark_gray>⏵ ",
            "system.prefix.payment" to "<#8600FF>₿ <dark_gray>⏵ ",
            "system.prefix.applied" to "<#00FF65>✎ <dark_gray>⏵ ",
