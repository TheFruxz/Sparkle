...
import de.moltenKt.paper.extension.paper.KeyFramesAlignment.*
 ...
 * @since 1.0
 */
fun Entity.showAnimatedTitle(title: List<Component>, subtitle: List<Component>, times: Times = Times(20.ticks, 60.ticks, 20.ticks), timeBetweenTicks: Duration = .1.seconds, alignment: KeyFramesAlignment = CENTER, renderFadeIn: Boolean = true) = MoltenApp.coroutineScope.launch {
